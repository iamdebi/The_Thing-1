      ...
      <section className="pregame-component">
        <div id="intro-text">
          <div className="text-container">
            ...
            <h3 className="text">
              •  Humans win if: 5 imitation blocked cards are played to the board.
              <br />
              •  Aliens win if: 5 imitation passed cards are played to the board OR
              <br />
              •  If The Thing is chosen as Co-Captain <u>after</u> 4 Imitation
              Successful cards have been played to the board.
            </h3>
            <br />
            <button className="pre-game-button" onClick={props.updateSwitcher}>
              Enter Player Names
            </button>
          </div>
        </div>
